...
uint16_t IntValuesWindow(char *title, int16_t min, int16_t max, int16_t value)
{
...
uint8_t DateValuesWindow(char *title, uint8_t *hours, uint8_t *minutes, uint8_t *seconds)
{  
  char *time_menu[4] = {"Std.", "Min.", "Sec.",""};
  char *keys_menu[4] = {"ESC", "", "","OK"};
