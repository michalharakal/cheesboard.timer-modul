...
{		  
  ...
  case stDarkness:    
	...
	roladen_demaerung=0;
	roller_shutters_delay = 60000; // 60000 x 10ms = 600s
    break;  
  }
#ifdef DEBUG
   printf("%.2d:%.2d:%.2d - ", time.hours, time.minutes, time.seconds);
...
void InitVariables (void)
{
  ...
  aInput[DEMMAERUNG].SetTreshold(400, 60000, 60000);  // war 600 / 17.07.10
  ...
  WindowUpTime.hours = 6;    // im Sommer 6:30, im Winter 7:15, hier und in rolade.cpp ändern
  WindowUpTime.minutes = 30;
